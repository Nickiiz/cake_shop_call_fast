...
import 'package:cake_shop_call_fast/views/show_shop_detail.ui.dart';
...
class _ShowShopUIState extends State<ShowShopUI> {
  //ตัวแปรเก็บข้อมูลรูปที่จะเอาไปใช้กับ Carousel
  ...
  //ตัวแปรเก็บข้อมูลแต่ละร้า่นไปใช้ใน ListView
